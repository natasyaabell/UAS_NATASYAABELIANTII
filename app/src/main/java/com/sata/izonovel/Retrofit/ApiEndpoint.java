...
public interface ApiEndpoint
{
    ...
    @Headers({"api-key:" + API_KEY, "Content-Type:application/json"})
    @POST("app/data-yvczw/endpoint/data/v1/action/findOne")
    Call<DetailNovelResponse> listDetailNovel(@Body DetailNovelRequest detailNovelRequest);

    @Headers({"api-key:" + API_KEY, "Content-Type:application/json"})
    @POST("app/data-yvczw/endpoint/data/v1/action/find")
    Call<ListFavoriteResponse> listfavorit(@Body SearchFavoritRequest searchFavoritRequest);
